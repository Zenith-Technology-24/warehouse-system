                ...
                render(row: { id: number | null, status: string }, value: number) {
                    return (
                        <div className="flex flex-row gap-2">
                            <div onClick={() => navigate('/inventory/update', { state: row })} className="p-2 rounded-full hover:bg-gray-100 cursor-pointer transition">
    ...
    return (
        <>
            ...
            <div className="flex flex-row justify-between">
                <Header title={'Product'} description={'Showing all Product'} />
                <TopButtons >
