...
const CreateIssuance: React.FC = () => {
  ...
  const createIssuanceMutation = useMutation({
    ...
    onSuccess: () => {
      showToast("Issuance Successfully Created!", "", "success");
      ...
      Yup.object().shape({
        ...
        inventory: Yup.array().of(
          Yup.object().shape({
            ...
            receiptRef: Yup.string().required(
              "Please input the Receipt Ref"
            ) as any,
                ...
                <div className="rounded-lg border border-gray-200 p-4">
                  ...
                  {values.endUsers.map((user: any, index: number) => {
                    return (
                      <div
                        key={index}
                        className="w-full grid grid-cols-2 items-center  gap-1 mt-5 mb-5"
                      >
