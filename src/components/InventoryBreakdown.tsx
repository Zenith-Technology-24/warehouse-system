...
const InventoryBreakdown: React.FC<InventoryBreakdownProps> = ({ title, color }) => {
    const data = [
        {
            size: '7 US',
            pairs: '60',
    ...
    return (
        <div className="rounded shadow p-2 space-y-2">
            ...
            <div className="grid grid-cols-5 divide-x divide-gray-200">
                {
                    data.map((item: { size: string, pairs: string, status: string }) => (
