      ...
      <div className="m-auto">
        <div className="flex flex-col bg-white border border-green-50 shadow-2xl w-[500px] shadow-[#4CAF5026] py-4 px-6 rounded-2xl">
          ...
          <div className="w-full p-2">
            <span className="text-aaa-text font-lato text-2xl font-[550]">
              Hi, Welcome back1!
            </span>
          </div>
          <div className="w-full p-2">
            <span className="text-aaa-text font-lato text-sm font-normal">
              Sign in to your Warehouse Inventory System account.
            </span>
          </div>
          <div>
            <div className=" mb-5">
              <label
                htmlFor="email"
                className="block mb-2 text-aaa-text font-lato text-sm font-normal"
              >
                Email Address
              </label>
              <input
                ...
                <div className="absolute inset-y-0 right-0 flex items-center pr-3">
                  {passwordType === "password" ? (
                    <svg
                      ...
                      viewBox="0 0 20 20"
                      fill="currentColor"
                      className="size-5 text-gray-700 cursor-pointer"
                    >
                      <path
                        fillRule="evenodd"
            ...
            <div className="flex items-center justify-between mx-1 mb-5 text-sm text-gray-900 font-normal">
              <div>
                ...
                />
                <label htmlFor="green-checkbox" className="ms-2">
                  Remember me
                </label>
              </div>
              <p>Forgot Password?</p>
            ...
            <div className="w-full">
              <button
                ...
                className="text-white bg-aaa opacity-90 hover:opacity-100 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center"
              >
                Sign In
              </button>
            </div>
