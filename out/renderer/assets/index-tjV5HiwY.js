import { f as useQueryClient, b as useLocation, a as useNavigate, u as useToast, r as reactExports, j as jsxRuntimeExports } from "./index-BwJeGL0w.js";
...
import { b as fetchOneIssuance, a as fetchReceiptRefs, h as updateIssuance } from "./issuanceApi-CQlqxOQ2.js";
...
const UpdateIssuance = () => {
  ...
  reactExports.useEffect(() => {
    if (data && receiptRefs) {
      setInitialValues({
        ...
        issuanceDate: hooks(data?.issuanceDate).format("YYYY-MM-DD"),
        validityDate: hooks(data?.validityDate).format("YYYY-MM-DD"),
        endUsers: data?.endUsers?.map((user, index) => ({
          id: user?.id,
          name: user?.name,
          inventory: user?.inventory?.map((inv, _index) => {
            const matchItem = receiptRefs?.find(
              (ref) => ref.name === inv?.item?.receiptRef
            );
            ...
            const item = mappedItems?.find(
              (item2) => item2?.name === inv?.item?.name
            );
  ...
  const updateIssuanceMutation = useMutation({
    mutationFn: (values) => updateIssuance(values),
    onError: (error) => {
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries(["receipt_details", state.id]);
  ...
  const validationSchema = create$3().shape({
    documentNo: create$6().required("Document No is required"),
    issuanceDirective: create$6().required(
      "Issuance Directive Nr. is required"
    ),
    issuanceDate: create$6().required("Issuance Date is required"),
    validityDate: create$6().required("Validity Date is required"),
    endUsers: create$2().of(
      create$3().shape({
        id: create$6().nullable(),
        name: create$6().required("End User is required"),
        inventory: create$2().of(
          create$3().shape({
            ...
            quantity: create$6().required("Inventory Quantity is required"),
            price: create$5().required("Inventory Price is required"),
            amount: create$5().required("Inventory Amount is required"),
            unit: create$6().required("Inventory Unit is required"),
            size: create$6()
          })
        )
      })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row justify-between pb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { title: "Update Issuance", description: "Issuance" }),
      ...
      Formik,
      {
        ...
        children: ({ values, setFieldValue }) => {
          const totalAmount = values.endUsers.reduce(
            (sum, user) => {
              return sum + user.inventory.reduce(
                (invSum, inv) => {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-gray-200 p-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full grid grid-cols-2 gap-1 mb-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-auto flex-col py-3", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    ErrorMessage,
                    {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row gap-5 mx-5", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "div",
                          {
                            onClick: () => setFieldValue("endUsers", [
                              ...values.endUsers,
                              {
                                id: "",
                                name: "",
                      ...
                      user?.inventory?.map(
                        (inventory, _index) => {
                          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full col-span-2 gap-4 relative bg-gray-50 px-6 py-2 my-2 rounded-lg border grid grid-cols-5 min-w-[600px] overflow-x-auto", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-row gap-5 absolute right-6 top-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "div",
                              {
                                onClick: () => {
                                ...
                                children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor", className: "w-5 h-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M6 18L18 6M6 6l12 12" }) })
                              }
                            ) }) }),
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-auto flex-col py-3", children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                Field,
                                {
                                  ...
                                  children: values.endUsers[index].inventory[_index].itemSizes?.length > 0 && values.endUsers[index].inventory[_index].itemSizes.map(
                                    (size, sizeIndex) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: size.itemId, children: size.name }, `${size.name}-${sizeIndex}`)
                                  )
                                }
                              ),
