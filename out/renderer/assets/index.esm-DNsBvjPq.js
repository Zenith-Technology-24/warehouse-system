import { g as getDefaultExportFromCjs, r as reactExports } from "./index-BwJeGL0w.js";
...
var createAlterationHandler = function createAlterationHandler2(alteration, defaultFunction) {
  ...
  return function(data) {
    if (Array.isArray(data) || isObject$1(data)) {
...
var FieldArrayInner = /* @__PURE__ */ function(_React$Component) {
  ...
  function FieldArrayInner2(props) {
    ...
    _this.updateArrayField = function(fn, alterTouched, alterErrors) {
      ...
      setFormikState(function(prevState) {
        ...
        var fieldError = alterErrors ? updateErrors(getIn$1(prevState.errors, name)) : void 0;
        var fieldTouched = alterTouched ? updateTouched(getIn$1(prevState.touched, name)) : void 0;
  ...
  _proto.componentDidUpdate = function componentDidUpdate(prevProps) {
    if (this.props.validateOnChange && this.props.formik.validateOnChange && !isEqual(getIn$1(prevProps.formik.values, prevProps.name), getIn$1(this.props.formik.values, this.props.name))) {
