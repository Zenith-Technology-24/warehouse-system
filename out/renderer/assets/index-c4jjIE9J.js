import { c as commonjsGlobal, g as getDefaultExportFromCjs, r as reactExports, R as React, j as jsxRuntimeExports } from "./index-BwJeGL0w.js";
...
import { D as DashboardCard } from "./DashboardCard-C1NcMtwM.js";
...
var parseLabel = function parseLabel2(label, viewBox) {
  ...
  if (isObject$8(label)) {
    return /* @__PURE__ */ React.createElement(Label$1, _extends$g({
      viewBox
    }, label, {
      key: "label-implicit"
    }));
...
function LabelList(_ref) {
  ...
  return /* @__PURE__ */ React.createElement(Layer, {
    ...
    return /* @__PURE__ */ React.createElement(Label$1, _extends$f({}, filterProps(entry, true), others, idProps, {
      parentViewBox: entry.parentViewBox,
      value,
      textBreakAll,
      viewBox: Label$1.parseViewBox(isNil$1(clockWise) ? entry : _objectSpread$k(_objectSpread$k({}, entry), {}, {
        clockWise
      })),
      key: "label-".concat(index),
      index
...
const COLORS$1 = { highStock: "#4CAF50", midStock: "#5799F8", lowStock: "#F44336", outOfStock: "#E7E9EC", total: "#ff1fff" };
...
const InventoryStatusPie = ({ counts }) => {
  const data = [
    { name: "High Stock", value: counts?.highStock || void 0 },
    { name: "Mid Stock", value: counts?.midStock || void 0 },
    { name: "Low Stock", value: counts?.lowStock || void 0 },
    { name: "Out of Stock", value: counts?.outOfStock || void 0 }
  ].filter((item) => item.value !== void 0 && item.value !== 0);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { width: 500, height: 600, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Pie,
      {
        ...
        fill: "#8884d8",
        dataKey: "value",
        children: Object.entries(counts || {}).filter(([key, value]) => value !== 0 && key !== "total").map(([key, value], index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Cell,
          {
            fill: COLORS$1[key],
            stroke: "white",
...
const Label = ({ label, value, bulletColor, bulletSize = 15 }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center flex flex-col justify-center mx-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center space-x-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg text-gray-500", children: label })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-2xl", children: value }) })
  ] });
};
...
const InventoryStatus = ({ data }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shadow-lg border border-gray-100 rounded-lg p-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-normal text-lg", children: "Inventory Status" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(InventoryStatusPie, { counts }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 px-6 mx-6", children: Object.entries(counts).filter(([key, value]) => value > 0 && key !== "total").map(([key, value], index) => {
        const labelMap = {
...
const InventoryReports = ({ data }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shadow-lg rounded-lg border border-gray-100 px-6 pb-5 pt-2 space-y-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-normal text-lg", children: "Inventory Reports" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 lg:grid-cols-6 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        DashboardCard,
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-aaa rounded-full p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "svg",
            {
              width: "16",
              height: "16",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        DashboardCard,
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#FFC107] rounded-full p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: "size-4 text-white", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { fill: "none", stroke: "currentColor", "stroke-linecap": "round", "stroke-width": "1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { "stroke-linejoin": "round", d: "M20.935 11.009V8.793a2.98 2.98 0 0 0-1.529-2.61l-5.957-3.307a2.98 2.98 0 0 0-2.898 0L4.594 6.182a2.98 2.98 0 0 0-1.529 2.611v6.414a2.98 2.98 0 0 0 1.529 2.61l5.957 3.307a2.98 2.98 0 0 0 2.898 0l2.522-1.4" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { "stroke-linejoin": "round", d: "M20.33 6.996L12 12L3.67 6.996M12 21.49V12" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { "stroke-miterlimit": "10", d: "M19.903 13.965v5m-2.494-2.495h5" })
          ] }) }) }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        DashboardCard,
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#2196F3] rounded-full p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: "size-4 text-white", viewBox: "0 0 48 48", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { fill: "none", stroke: "currentColor", "stroke-linecap": "round", "stroke-width": "4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { "stroke-linejoin": "round", d: "M4.592 19.467A2 2 0 0 1 6.537 17h34.926a2 2 0 0 1 1.945 2.467l-5.04 21A2 2 0 0 1 36.423 42H11.577a2 2 0 0 1-1.945-1.533z" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { "stroke-linejoin": "round", d: "M11 7h8v10h-8zm8 10l6.5-9L38 17" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M15 25h8" })
          ] }) }) }) }),
          title: "Total Receipt",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        DashboardCard,
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#9A59EE] rounded-full p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", className: "size-4 text-white", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { fill: "none", stroke: "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M9 14c0 1.657 2.686 3 6 3s6-1.343 6-3s-2.686-3-6-3s-6 1.343-6 3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M9 14v4c0 1.656 2.686 3 6 3s6-1.344 6-3v-4M3 6c0 1.072 1.144 2.062 3 2.598s4.144.536 6 0S15 7.072 15 6s-1.144-2.062-3-2.598s-4.144-.536-6 0S3 4.928 3 6" }),
...
const UserReports = ({ users }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shadow-lg rounded-lg border border-gray-100 px-6 pb-5 pt-2 space-y-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-normal text-lg", children: "User Reports" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 lg:grid-cols-3 gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        DashboardCard,
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-aaa rounded-full p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "white", className: "size-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" }) }) }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        DashboardCard,
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#4CAF50] rounded-full p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "white", className: "size-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0ZM3 19.235v-.11a6.375 6.375 0 0 1 12.75 0v.109A12.318 12.318 0 0 1 9.374 21c-2.331 0-4.512-.645-6.374-1.766Z" }) }) }) }),
          title: "Active Users",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        DashboardCard,
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-[#F44336] rounded-full p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "white", className: "size-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M22 10.5h-6m-2.25-4.125a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0ZM4 19.235v-.11a6.375 6.375 0 0 1 12.75 0v.109A12.318 12.318 0 0 1 10.374 21c-2.331 0-4.512-.645-6.374-1.766Z" }) }) }) }),
...
const Dashboard = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-row justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { title: "Dashboard", description: "Showing summary reports" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(InventoryReports, { data }),
    sessionData?.user?.roles[0]?.name === "superadmin" && /* @__PURE__ */ jsxRuntimeExports.jsx(UserReports, { users: data?.users }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(InventoryStatus, { data })
  ] });
};
export {
