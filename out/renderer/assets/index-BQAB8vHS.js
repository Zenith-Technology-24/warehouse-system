import { r as reactExports, a as useNavigate, u as useToast, j as jsxRuntimeExports } from "./index-BwJeGL0w.js";
...
import { c as createSales } from "./salesApi-BtYwXdgY.js";
...
const CreateSales = () => {
  const [isCustomerNew, setIsCustomerNew] = reactExports.useState(false);
  ...
  const createSalesMutation = useMutation({
    mutationFn: (values) => createSales(values),
    onError: (error) => {
      showToast(
  ...
  const validationSchema = create$3().shape({
    customer_id: !isCustomerNew && create$6().required("Customer is required"),
    customer_firstname: isCustomerNew && create$6().required("Customer first name is required").min(1, "Too short").max(250, "Too long"),
    customer_lastname: isCustomerNew && create$6().required("Customer last name is required").min(1, "Too short").max(250, "Too long"),
    customer_contactnumber: isCustomerNew && create$6().required("Contact number is required"),
    customer_address: isCustomerNew && create$6().required("Address is required").min(1, "Too short").max(250, "Too long"),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row justify-between pb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { title: "Create Sales", description: "Sales" }),
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(Form, { className: "w-full", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-gray-200 p-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full grid grid-cols-2 gap-1 border-b mb-5 pb-10", children: [
                isCustomerNew ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: " flex h-auto flex-col pt-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "pb-2 text-gray-500", htmlFor: "customer_address", children: "Address" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Field,
                      {
                        as: "input",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex mb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { onClick: () => setIsCustomerNew(false), className: "underline text-gray-400 text-sm hover:text-blue-500 cursor-pointer", children: "Customer already exist? Find now." }) })
                ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-auto flex-row py-3 item-center", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    DropdownWithSearch,
                    {
                      setFieldValue,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center mx-3 mt-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setIsCustomerNew(true), className: "rounded-lg font-lato bg-aaa text-white p-3 px-5", children: "Create" }) })
                ] }) }),
              ...
              values.inventories.map((inv1, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full grid grid-cols-2 gap-1 border-b mb-5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-auto flex-col py-3", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    DropdownWithSearch,
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorMessage, { className: "text-red-400", name: `inventories[${index}].id`, component: "div" }) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-auto flex-col py-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row gap-5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: () => setFieldValue("inventories", [...values.inventories, { id: null, quantity: null, total_price: null, terms: "30 days" }]), className: "flex flex-row gap-2 items-center text-sm text-gray-500 hover:text-gray-800 cursor-pointer", children: [
